...
public static class BuilderExtension
{
    public static void AddConfiguration(this WebApplicationBuilder builder)
    {
        ...
        Configuration.SendGrid.ApiKey = builder.Configuration.GetSection("SendGrid")
            .GetValue<string>("ApiKey") ?? string.Empty;
        
        Configuration.Email.DefaultEmail = builder.Configuration.GetSection("Email")
            .GetValue<string>("DefaultEmail") ?? string.Empty;
        Configuration.Email.DefaultSenderName = builder.Configuration.GetSection("Email")
            .GetValue<string>("DefaultSenderName") ?? string.Empty;
    }
